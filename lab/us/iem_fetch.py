...
OUT = Path("data/lab/us/asos"); OUT.mkdir(parents=True, exist_ok=True)
for st, tz in ST.items():
    parts = []
    for m in range(4, 10):
        d1 = 20 if m == 4 else 1; d2 = 22 if m == 9 else 30
        url = (f"https://mesonet.agron.iastate.edu/cgi-bin/request/asos.py?station={st}&data=tmpf&year1=2026&month1={m}&day1={d1}&year2=2026&month2={m}&day2={d2}"
